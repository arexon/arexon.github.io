<script>
	...
	let title = 'Arexon'
	let description =
		'Lowpoly 3D Artist, Pixel Artist, and Developer creating Minecraft content.'
	...
	<section class="hero">
		<div class="hero_main transition" class:animate={isInView}>
			...
			<div class="hero_main_buttons">
				<Button primary href="/projects" title="Go to Projects"
					>Explore Projects</Button
				>
				<Button secondary href="/gallery" title="Go to Gallery"
					>View Gallery</Button
				>
			</div>
		</div>
		<div class="hero_art transitionR" class:animate={isInView} />
	</section>
</Transition>
...
<style lang="scss">
	.hero {
		...
		&_main {
			...
			background: url('/assets/foregrounds/clouds-1.svg') 5% 95% / 50%
					no-repeat,
				url('/assets/foregrounds/clouds-2.svg') top right / 50%
					no-repeat;
		...
		&_art {
			...
			position: relative;
			display: none;
			background: $color-neutral-1 url('/assets/hero.png') center / 80%
				no-repeat;
		}
